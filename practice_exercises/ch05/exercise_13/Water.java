        ...
        public static void main(String[] args)
        {
                ...
                if (in.hasNextDouble())
                {
                        ...
                        if (in.hasNextDouble())
                        {
                                ...
                                String altitudeUnit = in.next();
                               
                               double boilingPointCelcius;
                                if (altitudeUnit.equalsIgnoreCase("m"))
                                {
                                        boilingPointCelcius = BOILING_POINT_C - altitude *
                                                1 / DELTA_TEMP_M;
                                        String state;
                                        ...
                                        else if (temperature >= boilingPointCelcius)
                                        {
                                                state = "gaseous steam";
                                        }
                                        else
                                ...
                                else if (altitudeUnit.equalsIgnoreCase("ft"))
                                {
                                        boilingPointCelcius = BOILING_POINT_C - altitude *
                                                1 / DELTA_TEMP_FT;
                                        String state;
                                ...
                                {
                                        System.out.println("Error: units of altitude are measured "
                                                + "in feet(ft)/meters(m).");
                                }
                        }
                        else
                        {
                                System.out.println("Error: Altitude should be a number");
                        }
                }
                else
                {
                        System.out.println("Error: Temperature should be of either type integer or double");
                }
        }                
}