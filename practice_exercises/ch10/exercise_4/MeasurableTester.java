...
public class MeasurableTester
{
    public static void main(String[] args)
    {
        ...
        // Calling the largest method with an array of BankAccount objects
        BankAccount account = (BankAccount) (Measurable.largest(accounts));
        double largestBalance = account.getBalance();
        System.out.println("Largest balance: " + largestBalance);
        System.out.println("Expected: 10000");
        
        // Calling the smallest method with an array of Country objects
        Country country = (Country) (Measurable.smallest(countries));
        double smallestArea = country.getArea();
