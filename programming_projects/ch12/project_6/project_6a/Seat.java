...
public class Seat
{
   ...
   */
   public Seat(int rowIndex, int colIndex, int n)
   {
      row = rowIndex;
      column = colIndex;
      type = n;
   ...
   */
   ...
   /**
      Gets this seat position within the rows in an airplane.
   ...
   */
   ...
   /**
      Gets the seat position within the columns in an airplane.
